...
<div class="wrap">
  ...
  <div class="tool-box">
    ...
    <div class="tablenav">
      <h2> 
		  <a class="button add-new-h2" href="<?php echo WP_vm_ADMIN_URL; ?>&amp;ac=add"><?php _e('Add New','vertical-marquee-plugin'); ?></a> 
		  <a class="button add-new-h2" href="<?php echo WP_vm_ADMIN_URL; ?>&amp;ac=set"><?php _e('Setting Management','vertical-marquee-plugin'); ?></a> 
		  <a class="button add-new-h2" target="_blank" href="<?php echo WP_vm_FAV; ?>"><?php _e('Help','vertical-marquee-plugin'); ?></a> 
	  </h2>
    </div>
    <br />
	<p class="description">

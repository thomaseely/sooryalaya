...
function wc_add_to_cart_message( $products, $show_qty = false ) {
	...
	$added_text = sprintf( _n( '%s has been added to your cart. Click the "View Cart" button.', '%s have been added to your cart. Click the "View Cart" button.', $count, 'woocommerce' ), wc_format_list_of_items( $titles ) );
